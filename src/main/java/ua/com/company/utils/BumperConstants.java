...
//   public static final long DELAY_BEFORE_DELETE_MESSAGE = 4*60*1000+30*1000;//4min 30 sec
   public static final long DELAY_BEFORE_SEND_ANOTHER_MESSAGE = 30*1000;//5min
//   public static final long DELAY_BEFORE_SEND_ANOTHER_MESSAGE = 5*60*1000;//5min
//    public static final long PAUSE_BETWEEN_NEW_TASK = 4*60*60*1000L;
    public static final long PAUSE_BETWEEN_NEW_TASK = 5;//MINUTES
